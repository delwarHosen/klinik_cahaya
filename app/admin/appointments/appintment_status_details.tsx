...
// ─── Status config (Labels are fixed as per your requirement)
...
export default function AppointmentStatusScreen() {
  ...
  const relation = isSelf ? t('own_self') : (patientFor || t('other'))
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <Caption1 style={[styles.label, { marginTop: hp(20) }]}>{t('visit_reason')}</Caption1>
        ...
        {/* Booked By section */}
        {bookedByName && (isCompleted || !isSelf) && (
          <>
            <Caption2 style={[styles.label, { marginTop: hp(16) }]}>{t('booked_by')}</Caption2>
            <View style={styles.personCard}>
              <View style={styles.personAvatar} />
              <View style={styles.personInfo}>
